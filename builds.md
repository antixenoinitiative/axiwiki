...
[AXCZ Krait Mk.II repairless Modified Shard Cannons Build](https://edsy.org/s/vxeLKnl)
[AXCZ Krait Mk.II repairless Modified Plasma Chargers Build](https://edsy.org/s/vtUB6k2)

### Maelstrom Krait Mk.II
![krait-mk-ii.png](/img/krait-mk-ii.png =250x){.align-right}
#### **Maelstrom Diver Build**

The Krait Mk.II is a tried and true favorite of maelstrom divers, as it offers substantial firepower and optional internals, while still maintaining good maneuverability.  The Maelsotrom (or TitanKiller) Krait can be outfitted with a variety of weapon loadouts; the example given is the "fighter" configuration wwith Enhanced AX Multi-Cannons.  For more detail on alternative optiosn, visit the "Titan builds" seciton below.
