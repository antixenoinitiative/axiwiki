...
A swarm can be kept in the standard state for the entire duration of the fight, simply by never agitating the swarm. _**This means that agile ships <span style="font-style: normal; text-decoration: underline;">can</span> avoid using flak altogether**_.
