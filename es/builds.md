...
En primer lugar, tenga en cuenta que hay dos tipos principales de Thargoides: **Exploradores Thargoides** e **Interceptores de Thargoides**. Dado que estos enemigos tienen mecanismos y capacidades muy diferentes, normalmente necesitaremos un tipo diferente de construcción para cada uno. Combat in Maelstrom systems prevents the use of guardian technology, so they require specialized combat vessels packing unique armaments. These builds are outclassed for combat outside of Maelstrom systems, so building a regular interceptor build first is recommended.
