...
Pre-engineered heatsinks can be purchased from Sirius Corp. Megaships, which contain an additional two heatsinks per ammunition loadout.  They can be purchased for the following cost:
- ** 8 Mechanical Scrap **
- ** 6 Niobium**
- ** 6 Vanadium **
