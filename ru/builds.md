...
Охота на таргоидов требует особой сборки корабля, так как таргоиды имеют дополнительное сопротивление урону из человеческих орудий и наносят особые типы урона, которые создадут проблемы для любой привычной боевой сборки. Поэтому мы составили данное руководство, чтобы помочь вам принять правильные решения, которые приведут вас к созданию наиболее эффективного корабля для охоты на таргоидов. Эти сборки кораблей разработаны таким образом, чтобы обеспечить баланс огневой мощи и живучести, и в то же время быть достаточно лёгкими, чтобы совершить несколько ошибок.

> Для более подробных разъяснений использованных решений, пожалуйста, ознакомьтесь со страницей [Теория сборки AX-корабля](/en/shipbuildtheory). 
> 
> {.is-info}

## Типы сборок кораблей

Во-первых, обратите внимания на два основных типа таргоидов: **таргоидские разведчики** и **таргоидские перехватчики**. Поскольку эти противники имеют очень разные механики и способности, для каждого из них, как правило, требуется свой тип сборки корабля. Combat in Maelstrom systems prevents the use of guardian technology, so they require specialized combat vessels packing unique armaments. These builds are outclassed for combat outside of Maelstrom systems, so building a regular interceptor build first is recommended.

# Сборки против перехватчиков

Перехватчики таргоидов — очень сильные и мощные враги, для борьбы с которыми потребуются не менее сильные корабли. Из-за невероятно высокого урона, наносимого таргоидскими перехватчиками, существует лишь несколько различных эффективных стилей и методов борьбы с ними, которые вы можете эффективно использовать.
